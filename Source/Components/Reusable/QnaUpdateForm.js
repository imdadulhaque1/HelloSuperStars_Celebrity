...
const QnaUpdateForm = ({route}) => {
  ...
  const [date, setDate] = useState(
    new Date(moment(oldEventData.event_date).format()),
  );
  ...
  const [startDate, setStartDate] = useState(
    new Date(moment(oldEventData?.registration_start_date).format()),
  );
  const [endDate, setEndDate] = useState(
    new Date(moment(oldEventData?.registration_end_date).format()),
  );
