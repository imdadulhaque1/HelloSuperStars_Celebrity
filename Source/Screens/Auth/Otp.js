...
const Otp = ({route}) => {
  ...
  const HandelLogin = () => {
    navigation.navigate(AuthNavigationString.HELLOSTAR);
    return;
    setBuffer(true);
    ...
    axios
      .post(AppUrl.superStarOtp, fdata, axiosConfig)
      .then(res => {
        setBuffer(false);
          ...
          <Animatable.View style={styles.footerBody} animation="slideInUp">
            <View style={styles.footer}>
              ...
              <Text style={styles.TextDes}>
                We have sent an SMS to your {phone} Phone Number
              </Text>
              <OTPInputView
                style={styles.InputOTPx}
                pinCount={6}
                autoFocusOnLoad
