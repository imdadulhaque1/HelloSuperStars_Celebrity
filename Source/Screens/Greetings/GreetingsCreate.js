...
const GreetingsCreate = () => {
  ...
  const onSubmit = data => {
    ...
    axios
      .post(AppUrl.greetingsAdd, newData, axiosConfig)
      .then(res => {
          ...
          <View style={{padding: 12}}>
            ...
            <View style={{marginVertical: 8}}>
              <View style={{flexDirection: 'row'}}>
                ...
                <View style={{flex: 1}}>
                  <Text style={styles.title}>Require Day Before Date</Text>
                </View>
              </View>
              <View style={{flexDirection: 'row'}}>
                <View style={{width: '50%'}}>
                ...
                <View style={{width: '50%'}}>
                  <Controller
                    ...
                    name="user_required_day"
                  />
                  {errors.user_required_day && (
                    <Text style={{color: 'red', marginLeft: 10, marginTop: -7}}>
                      This is required.
                    </Text>
                  )}
...
export default GreetingsCreate;
